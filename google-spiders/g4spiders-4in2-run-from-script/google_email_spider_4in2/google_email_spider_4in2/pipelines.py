...
from google_email_spider_4in2.items import *
...
class S3In1GoogleDupfilterPipeline(object):
...
class S1GoogleDupfilterPipeline(object):
...
class S1GoogleDupfilterValidNamePipeline(object):
...
class S1GoogleSpiderPipeline(object):
