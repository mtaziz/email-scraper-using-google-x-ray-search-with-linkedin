...
test_linkedin_url = ['https://ca.linkedin.com/in/kerrynmatthews-6897b893',
                     'https://www.linkedin.com/in/xiaokui-zhang-868404a']
names_in_title_list = ['Kerryn Matthews | LinkedIn',
                       'Xiaokui Zhang | LinkedIn', 'Xiaokui Zhan | LinkedIn']
test_name_list = []
...
test_linkedin_url = ['https://ca.linkedin.com/in/kerryn-matthews-6897b893',
                     'https://www.linkedin.com/in/xiaokui-zhang-868404a']
names_in_title_list = ['Kerryn Matthews | LinkedIn',
                       'Xiaokui Zhang | LinkedIn', 'Xiaokui Zhan | LinkedIn']
test_name_list = []
...
with open(input_file, 'rb') as file_read:
    ...
    for url in reader:
        ...
        re_match = re.match(pattern, r_split)
        r_split_name = (
            ' '.join((r_split.split('/in/')[-1].split('-')))).title()
        names_in_linkedin_url_list.append(r_split_name)
#     print(r_split_name)
#     print(r_split_name)
